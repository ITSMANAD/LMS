                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                درآمد (ماهانه)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">تومان40,000</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                درآمد (سالانه)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">تومان215,000</div>
                                        </div>
                                        <div class="col-auto">
